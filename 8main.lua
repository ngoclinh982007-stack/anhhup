-- language: Lua, file: 6main.lua, target: Roblox (Delta mobile)
-- Full anhhub + immortal toolkit tich hop trong menu
warn("[anhhub] v6 full + immortal")
...
local function runTool()
    ...
    menu.CanvasSize,menu.AutomaticCanvasSize=UDim2.new(0,0,0,1500),Enum.AutomaticSize.None
    ...
    ap.MouseButton1Click:Connect(function()
        ...
        b.MouseButton1Click:Connect(function()
            ...
            ni.Font,ni.TextSize,ni.ClearText =OnFocus = Enum.Font.Gotham,12,false
            Instance.new("UICorner",ni).CornerRadius = UDim.new(0,6)

            local opts = {
                {l="1 giờ",            e={ Uhours=1},   admin=false},
                {l="1 ngày",           e={days=1},    admin=false},
                {l="1 tuầnDim",           e={weeks=1},   admin=false},
            ...
            Instance.new("UICorner",db).CornerRadius.new(0,6)
