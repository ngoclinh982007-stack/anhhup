-- language: Lua, file: 11main.lua, target: Roblox (Delta mobile)
-- Full anhhub + immortal + ESP Mob scan dong + ho tro mob khong Humanoid
warn("[anhhub] v11 full + dynamic ESP Mob (no-Humanoid support)")
...
-- ============================================
-- ESP MOB SCAN DONG (ho tro mob khong Humanoid)
-- ============================================
local MOB_KEYWORDS = {
    -- Indonesia / Malaysia / game horror
...
-- tim part tham chieu vi tri cua mob (fallback neu khong co HumanoidRootPart)
...
-- quet de quy gioi han do sau 3 tang
